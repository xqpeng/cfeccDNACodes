...
def loadFeature(Case_path, Control_path, X_train, X_test, Feature):
    ...
    def read_and_process(file_path):
        try:  
            if Feature in ['BPM_CFDNA', 'EDM_CFDNA']:
...
def main():
    ...
    feature_type = ['BPM_CFDNA', 'EDM_CFDNA', 'FSC', 'FSD', 'CNV']
    ...
    results_disease.append(
        ['CFDNA', args.DiseaseCase_samples_dir, blend_accuracy, blend_specificity, blend_recall, blend_f1, blend_auc]
    )
    roc.append(['CFDNA', blend_mean_fpr1, blend_tpr_interp, blend_auc])
